defmodule ShowcagoServicesWeb.UserAuth do
  ...
  @remember_me_cookie "_showcago_services_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ShowcagoServicesWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      ShowcagoServicesWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule ShowcagoServicesWeb.PageLive do
        use ShowcagoServicesWeb, :live_view

        on_mount {ShowcagoServicesWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ShowcagoServicesWeb.UserAuth, :require_authenticated}] do
